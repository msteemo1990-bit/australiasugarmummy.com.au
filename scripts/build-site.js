...
const blogPosts = [
  ...
  },
  {
    ...
    body: [
      ...
      ["Which behaviours should end the conversation?", "End the conversation if someone asks for upfront transfers, tries to bypass verification, uses escort-style pricing language, threatens exposure, or pushes intimacy before trust. These patterns are not signs of confidence; they are signals that the connection is not aligned with mature sugar dating."]
    ],
  ...
  },
  {
    ...
    title: "How to Spot Sugar Dating Scams Before They Escalate",
    seoTitle: "Sugar Dating Scams Australia | Australia Sugar Mummy",
    eyebrow: "Anti-scam",
    description: "Common sugar dating scam patterns in Australia and practical decision rules for ending risky conversations early.",
    lead: "Most sugar dating scams rely on speed. The scammer tries to create urgency before you can notice contradictions, verify identity, or compare the request against normal adult dating behaviour.",
    image: "/assets/images/article-scam.jpg",
    alt: "Phone and notebook used to review online dating safety notes",
    sections: [
      { title: "Scams do not start with the ask", paragraphs: ["The first thing to understand about sugar dating scams is that the dangerous moment is rarely the first obvious request. By the time someone asks for a transfer, a gift card, crypto, travel money, or a strange verification fee, they have usually spent several messages preparing the ground.", "They may begin with admiration. They may sound unusually certain about you. They may talk as if the relationship already has emotional weight before you have met in person. That early warmth is not proof of a scam by itself, but it becomes meaningful when it is used to make ordinary caution feel rude. A scam often starts by making you feel chosen, then slowly turns that feeling into an obligation."] },
      { title: "The performance of urgency", paragraphs: ["Urgency is the scammer's favourite stage lighting. It changes the room. A normal request gives you time to think, compare details, ask a friend, search a phrase, or sleep on the decision. An urgent request tries to make all of that feel impossible.", "In sugar dating, urgency often arrives dressed as romance, privacy, or opportunity. Someone has a sudden travel problem. A bank account is frozen. A meeting can only happen tonight. A profile will disappear unless you move to another channel. A gift needs to be sent before trust can continue. The point is not the story; the point is the clock. Once a stranger makes speed the condition of connection, you should slow the conversation down instead of speeding yourself up."] },
      ...
      { title: "When affection becomes a lever", paragraphs: ["One of the most confusing parts of sugar dating scams is that the manipulation can sound affectionate. The person may call you special, loyal, rare, mature, generous, or unlike everyone else. Then the compliment becomes a lever: if you really cared, you would help; if you trusted them, you would send proof; if you were serious, you would not question the request.", "This is where many smart people get caught, because they are not responding to the money request alone. They are responding to the implied accusation that caution means coldness. It does not. Caution is not the opposite of generosity. It is the structure that keeps generosity from becoming exposure. A real connection can survive a calm no. A scam often cannot."] },
      { title: "Follow the money, then stop", paragraphs: ["You do not have to solve the whole mystery. You do not have to prove the person is lying, identify the exact script, or win an argument about whether the emergency is real. In early sugar dating conversations, certain money patterns are enough to end the exchange.", "Upfront transfers, gift cards, crypto, bank access, account unlocking, travel advances, paid verification links, refund promises, and requests to receive or move money for someone else are not romantic complications. They are financial risk. A mature person may talk about lifestyle expectations, gifts, support, or relationship rhythm later, after identity and trust have had time to form. A stranger who needs unrecoverable money before meeting has already given you the most important information."] },
  ...
  },
  {
    ...
    eyebrow: "Profiles",
    description: "Profile-writing tips for mature Australian women looking for respectful sugar dating introductions.",
...
const common = {
  ...
  FOOTER_COPY: `${brand} is an adults-only introductory website for people aged 18 and over. It does not promote escort services, paid encounters, coercion, or financial pressure. Published content is general information, not legal, financial, or personal safety advice.`,
...
function buildHome() {
  ...
  const data = {
    ...common,
    META_TITLE: "Australia Sugar Mummy Dating | Mature Sugar Dating",
    ...
    TRUST_TITLE: "A calmer standard for modern sugar dating",
    TRUST_CARD_TITLE_1: "Adults Only",
    TRUST_CARD_COPY_1: "The site is written for adults aged 18 and over who can make independent relationship choices.",
    ...
    CTA_TITLE: "Register for a more selective sugar dating standard",
...
function buildHubAndAudience() {
  pageShell({
    ...
    eyebrow: "Sugar dating Australia",
    h1: "Sugar Mummy Dating in Australia",
    lead: "A practical hub for adults who want mature, discreet, and long-term sugar dating built around mutual respect rather than short-term transactions.",
  ...
  for (const [index, [name, url]] of cities.entries()) {
    ...
    pageShell({
      ...
      body: isSydney ? [
        ...
        { title: "Best next page for Gold Coast readers", paragraphs: ["Use the <a href=\"/sugar-mummy/\">main sugar mummy dating guide</a> to define the relationship model, then read the <a href=\"/blog/sugar-dating-safety-australia/\">sugar dating safety checklist</a>. If a lifestyle promise starts to feel urgent, expensive, or secretive, check the <a href=\"/anti-scam/\">anti-scam guide</a> before agreeing to anything."] }
      ] : [
...
function buildTrustAndLegal() {
  const pages = [
    ...
    ["/privacy/", `Privacy Policy | ${brand}`, `Read how ${brand} may collect, use, share, retain, and protect information for support, safety, analytics, and legal compliance.`, "Legal", "Privacy Policy", `This Privacy Policy explains how ${brand} may collect, use, share, retain, and protect information when you use ${domain}. It is a template for the current static site and should be reviewed by qualified legal counsel before publication or before collecting user data.`, [
      ...
      { title: "Children and age limits", paragraphs: ["The site is intended only for adults aged 18 and over. Minors must not use Australia Sugar Mummy, submit personal information, create profiles, or participate in any dating-related feature.", "If the site becomes aware that personal information from a minor has been collected, it should take appropriate steps to delete or restrict that information according to law and safety obligations."] },
    ...
    ["/terms/", `Terms of Use | ${brand}`, `Read ${brand} rules for eligibility, conduct, safety limits, user content, paid feature terms, and enforcement.`, "Legal", "Terms of Use", `These Terms govern access to and use of ${domain} and ${brand}. They are a template for the current static site and should be reviewed by qualified legal counsel before publication, before collecting user data, or before enabling live account features.`, [
      ...
      { title: "Eligibility", paragraphs: ["You must be at least 18 years old and legally able to use dating or relationship-discovery services in your jurisdiction. Minors may not use Australia Sugar Mummy, create accounts, submit information, or participate in any dating-related feature.", "You agree to provide accurate information, use the site lawfully, respect other users, and stop using the site if you are prohibited from doing so under applicable law or these Terms."] },

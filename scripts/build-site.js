...
function buildHome() {
  ...
  const data = {
    ...
    EDITORIAL_TITLE: "A new standard for sugar mummy dating",
    EDITORIAL_PARAGRAPH_1: "Unlike old transactional ideas about sugar mummy dating, Australia Sugar Mummy is built for a more selective kind of relationship. We are designed for adults who value real-person verification, long-term compatibility, discretion, and emotional maturity. If you are not comfortable with strict identity verification, this may not be the right place for you.",
    EDITORIAL_PARAGRAPH_2: "Our purpose is to help accomplished mature women and polite, energetic younger men create relationships with lasting value, without the pressure of traditional marriage and without reducing the connection to short-term exchange. If you are looking for paid short-term access, or if you expect to buy temporary attention, this platform is probably not aligned with your intentions.",
    EDITORIAL_PARAGRAPH_3: "The sugar mummies we speak to are elegant women with careers, self-possession, warmth, and a refined sense of life. Many want to offer guidance, perspective, emotional intelligence, career insight, and life experience while feeling the satisfaction that comes from helping someone grow. The younger men who fit our values bring energy, manners, presence, and long-term companionship, adding vitality to a busy woman's free time without creating the emotional exhaustion that can come from possessive expectations.",
    EDITORIAL_PARAGRAPH_4: "We maintain a strict verification culture because quality matters more than volume. Australia Sugar Mummy is not built for a large, chaotic crowd; it is for a smaller circle of people who genuinely share our values. We are not here to keep users browsing endlessly online. We exist to support meaningful offline meetings between people who understand that life belongs to them, that money cannot buy emotional value, and that no one else gets to define the relationship that fits them best.",
    ...
    TESTIMONIAL_HEADLINE_1: "A calmer place to understand the rules",
    TESTIMONIAL_COPY_1: "Australia Sugar Mummy made the whole topic feel clearer and more respectful. The safety notes, city pages, and profile advice helped me think about privacy before starting a conversation.",
    TESTIMONIAL_AVATAR_1: `/assets/images/${homeReplacementImages.testimonialAvatar1}`,
    TESTIMONIAL_AUTHOR_1: "Reader feedback from Sydney",
    TESTIMONIAL_SOURCE_2: "User feedback",
    TESTIMONIAL_HEADLINE_2: "Useful guidance without the noise",
    TESTIMONIAL_COPY_2: "I liked that the site talks about mature expectations, public-first meetings, and scam warning signs in plain language. It feels more thoughtful than a typical dating landing page.",
    TESTIMONIAL_AVATAR_2: `/assets/images/${homeReplacementImages.testimonialAvatar2}`,
    TESTIMONIAL_AUTHOR_2: "Reader feedback from Melbourne",
